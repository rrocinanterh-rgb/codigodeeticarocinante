...
- solicita o e-mail antes de liberar o documento;
...
para o projeto. A planilha recebe uma linha com e-mail, abertura, status, versão
do documento e, depois da confirmação, data de conclusão e tempo.
